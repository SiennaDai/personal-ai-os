...
readonly AGENT_DIRECTORIES=(learning-agent research-agent writing-agent coding-agent)
readonly SKILLS=(assessment code-review document-understanding education-learning evidence-synthesis knowledge-extraction knowledge-mapping literature-search software-verification stem-reasoning structured-writing systematic-debugging visualization writing-revision)
...
printf 'Validated Agents: learning_agent research_agent writing_agent coding_agent\n'
